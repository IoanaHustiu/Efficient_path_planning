function [feasible_sol , marking_final, Rob_positions_final, Rob_places, Rob_trans, Rob_synchronize, tr_number] = test_solution_feasibility(Pre, Post, m0, props, Obs, obs_type, set_ind_fin, set_ind_traj, k, solver, xmin, status, Rob_positions)
...
for i=1:k
    ...
    [feasible_sigma, Rob_places_i, Rob_trans_i, Rob_positions_next] = sigma2trajectories(Pre,Post,m0,sigma,Rob_positions); %construct places and transition sequences in PN
